          ...
          <div className="relative w-full max-w-[480px]">
            ...
            <div className="absolute -top-4 -left-4 bg-white p-4 rounded-2xl shadow-xl z-30 flex items-center space-x-3 border border-slate-50">
               ...
               <div>
                 ...
                 <div className="text-xs font-extrabold text-slate-900">Processo iniciado em até 24h</div>
               </div>
            </div>

            {/* Badge flutuante 2 - Urgência (Reposicionado da esquerda) */}
            <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-2xl shadow-xl z-30 flex items-center space-x-3 border border-slate-50">
               <div className="bg-emerald-50 p-2 rounded-xl text-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.2)]">
                  <span className="flex h-2.5 w-2.5 rounded-full bg-emerald-500 animate-pulse"></span>
               </div>
               <div>
                 <div className="text-[9px] font-bold text-slate-400 uppercase tracking-tight">Prioridade</div>
                 <div className="text-xs font-extrabold text-slate-900">Análise imediata para urgências</div>
               </div>
            </div>
